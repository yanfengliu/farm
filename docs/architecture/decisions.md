...
| 2026-07-04 | Use Phaser as the initial renderer. | Phaser is a low-risk fit for top-down pixel-art sprites, camera, input, and audio while leaving rules outside the scene. |
