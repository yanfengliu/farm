...
- Rebuilt the north and east hedgerows from repeated rectangular strips into deterministic thickets of rounded pixel-leaf clusters with crooked crowns, uneven baselines, broken shadows, sparse blossoms, ground sprouts, and occasional young shoots. Farm Notes now identify those graphics as North or Wild Hedgerow instead of the meadow beneath them, and the default camera keeps the complete east thicket visible at both supported desktop sizes.
